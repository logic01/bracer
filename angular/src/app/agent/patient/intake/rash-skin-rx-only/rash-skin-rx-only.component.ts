...
export class RashSkinRxOnlyComponent implements OnInit {
  ...
  initQuestions() {
    ...
    question1.key = 'q1';
    question1.text = '1. Where is your rash/skin irritation located?';

    const question2 = new Question();
    question2.key = 'q2';
    question2.text = '2. How long have you had it?';

    const question3 = new Question();
    question3.key = 'q3';
    question3.text = '3. What is the cause of your skin irritation?';

    const question4 = new Question();
    question4.key = 'q4';
    question4.text = '4. Have you treated the skin irritation before?';
