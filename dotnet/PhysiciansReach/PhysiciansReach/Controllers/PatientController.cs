...
namespace PhysiciansReach.Controllers
{
    ...
    public class PatientController : ControllerBase
    {
        ...
        {
            _logging.Log(PR.Data.Models.Log.LogSeverity.Info, "Get All Patient");
        ...
        {
            _logging.Log(PR.Data.Models.Log.LogSeverity.Info, "Get Patient");
        ...
        {
            _logging.Log(PR.Data.Models.Log.LogSeverity.Info, "Post Patient");
        ...
        {
            _logging.Log(PR.Data.Models.Log.LogSeverity.Info, "Put Patient");
